...
<header class="bg-white shadow-lg sticky top-0 z-50 transition-opacity duration-500">
  <div class="container mx-auto px-4 py-4 flex justify-between items-center">
    ...
    <div class="flex items-center space-x-4">
      <button on:click={toggleCart} class="text-gray-600 hover:text-gray-900 bg-transparent hover:bg-gray-200 p-2 rounded" aria-label="cart">
      ...
      <button on:click={toggleProfile} class="text-gray-600 hover:text-gray-900 bg-transparent hover:bg-gray-200 p-2 rounded" aria-label="profile">
